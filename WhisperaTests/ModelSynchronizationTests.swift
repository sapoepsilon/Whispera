...
final class ModelSynchronizationTests: XCTestCase {
    ...
    func testSettingsViewSelectedModelProperty() async throws {
        ...
        XCTAssertEqual(UserDefaults.standard.string(forKey: "selectedModel"), newModel,
    ...
    func testIsCurrentModelLoadedLogic() async throws {
        ...
        XCTAssertFalse(transcriber.isCurrentModelLoaded(),
        ...
        XCTAssertTrue(transcriber.isCurrentModelLoaded(),
