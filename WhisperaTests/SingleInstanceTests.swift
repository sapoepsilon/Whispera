...
final class SingleInstanceTests: XCTestCase {
    ...
    func testApplicationDoesNotLaunchMultipleInstances() {
        ...
        let shouldReopen = appDelegate.applicationShouldHandleReopen(NSApplication.shared, hasVisibleWindows: false)
    ...
    func testDockIconClickActivatesExistingInstance() {
        ...
        let shouldReopen = appDelegate.applicationShouldHandleReopen(NSApplication.shared, hasVisibleWindows: true)
