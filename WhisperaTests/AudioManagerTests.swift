...
final class AudioManagerTests: XCTestCase {
    ...
    func testStreamingModeToggle() async throws {
        ...
        // Then
        XCTAssertNotEqual(audioManager.useStreamingTranscription, initialStreamingMode, "Streaming mode should toggle")
    }
    ...
    func testDefaultStreamingModeIsEnabled() async throws {
        ...
        // Then
        XCTAssertTrue(audioManager.useStreamingTranscription, "Streaming mode should be enabled by default")
    }
    ...
    func testStreamingModeStorage() async throws {
        ...
        XCTAssertEqual(storedValue, testValue, "Streaming mode preference should be stored in UserDefaults")
    }
    ...
    func testApplicationSupportDirectoryCreation() async throws {
        ...
        // Then
        XCTAssertTrue(FileManager.default.fileExists(atPath: directory.path), "Application support directory should exist")
    ...
    func testWhisperKitTranscriberReference() async throws {
        ...
        XCTAssertTrue(transcriber === WhisperKitTranscriber.shared, "Should reference the shared instance")
    }
