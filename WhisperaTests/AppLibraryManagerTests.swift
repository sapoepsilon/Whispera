...
final class AppLibraryManagerTests: XCTestCase {
    ...
    func testAppLibraryErrorDescriptions() {
        XCTAssertEqual(AppLibraryError.directoryNotFound.errorDescription, "App library directory not found")
        XCTAssertEqual(AppLibraryError.accessDenied.errorDescription, "Access denied to app library")
        XCTAssertEqual(AppLibraryError.deletionFailed("test").errorDescription, "Failed to delete: test")
        XCTAssertEqual(AppLibraryError.calculationFailed.errorDescription, "Failed to calculate storage usage")
    }
